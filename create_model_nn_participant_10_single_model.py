...
orig_epochs = loadtxt('loaded_complete_data_10_2_sec.csv', delimiter=',')
...
# Create the model  ################## BEST ONE - SO FAR - 10th participant - 2 sec samples #######################
...
model=Sequential()
model.add(Conv1D(filters=65, kernel_size=5, kernel_regularizer=L2(my_L2), bias_regularizer=L2(my_L2), activity_regularizer = L2(my_L2), kernel_constraint=min_max_norm(min_value=negative_wt, max_value=positive_wt), padding='valid', activation='relu', strides=2, input_shape=(500, 64)))
model.add(AveragePooling1D(pool_size=2)) 
model.add(Conv1D(filters=65, kernel_size=5, kernel_regularizer=L2(my_L2), bias_regularizer=L2(my_L2), activity_regularizer = L2(my_L2), kernel_constraint=min_max_norm(min_value=negative_wt, max_value=positive_wt), padding='valid', activation='relu', strides=2))
